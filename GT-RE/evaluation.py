...
def to_official(preds, features, dataset ='docred'):
    ...
    elif dataset == 'redocred':
        id2rel = redocred_id2rel
    elif dataset == 'biored':
...
def official_evaluate(tmp, path, tag, dataset):
    ...
    if dataset == 'docred' or dataset == 'redocred':
    ...
    print("correct_re:{}".format(correct_re))
    print("tot_relations:{}".format(tot_relations))
    print("submission_answer:{}".format(len(submission_answer)))
